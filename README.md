...
This organization contains **four companion repositories**:

- **[Code](https://github.com/higher-ed-policy-analysis-2nd-edition/code):** Stata scripts for analyses; some R script translated from Stata
- **[Data](https://github.com/higher-ed-policy-analysis-2nd-edition/data):** Datasets in Stata, CSV, Excel formats
- **[Figures](https://github.com/higher-ed-policy-analysis-2nd-edition/figures):** Publication-quality graphics
- **[Tables](https://github.com/higher-ed-policy-analysis-2nd-edition/tables):** Supplementary statistical tables

**Navigation:**  
Each repo contains folders by chapter (`ch4`, `ch5`, ..., `ch12`). Start with the relevant chapter folder as you work through the book.
...
**Students:**  
1. Read the book and select a chapter  
2. Download data from [Data](https://github.com/higher-ed-policy-analysis-2nd-edition/data)  
3. Run Stata scripts from [Code](https://github.com/higher-ed-policy-analysis-2nd-edition/code)  
4. Compare results with [Figures](https://github.com/higher-ed-policy-analysis-2nd-edition/figures) and [Tables](https://github.com/higher-ed-policy-analysis-2nd-edition/tables)

**Instructors:**  
- Integrate figures, assign code exercises, and adapt materials to your course

**Researchers:**  
- Replicate examples, adapt code and data, cite appropriately

---

## Repository Structure

Here’s a more readable and compact version using a bullet list per chapter, showing all links clearly:

````markdown
## Chapter Materials Overview

**Each chapter has dedicated folders in all four companion repositories:**
...
- **Clone repositories:**
  ...
  git clone https://github.com/higher-ed-policy-analysis-2nd-edition/data.git
  git clone https://github.com/higher-ed-policy-analysis-2nd-edition/figures.git
  git clone https://github.com/higher-ed-policy-analysis-2nd-edition/tables.git
  ```
- Or download ZIP files from each repository.

**Software:**  
Stata 15+ recommended. Data is compatible with R/Python via CSV/Excel.

---

## FAQ & Troubleshooting

- Find answers to common questions and solutions in each repository’s README.
- Open an Issue for errors or questions.

---

## Citation & License

- Cite the book and repositories when using materials.
- **Code:** MIT License  
- **Data, Figures, Tables:** CC BY 4.0

---

## Get Help & Contribute

- Use Issues and Discussions in each repo.
- Contributions, suggestions, and improvements are welcome!

---

**Start with ch4 for hands-on practice. Visit repository READMEs for details.**  
Questions? Open a [Discussion](https://github.com/higher-ed-policy-analysis-2nd-edition/Project-Overview/discussions).

Note: Portions of README were drafted with the assistance of a generative Ai tool and reviewed and edited by the author.
